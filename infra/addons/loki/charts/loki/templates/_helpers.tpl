...
{{- if eq .Values.loki.storage.type "aws" }}
aws:
  {{- if .Values.loki.storage.bucketNames }}
  bucketnames: {{ .Values.loki.storage.bucketNames.chunks | default "" }}
  {{- else }}
  bucketnames: ""
  {{- end }}
  ...
...
gcs:
  {{- if .Values.loki.storage.bucketNames }}
  bucket_name: {{ .Values.loki.storage.bucketNames.chunks | default "" }}
  {{- else }}
  bucket_name: ""
  {{- end }}
  ...
{{- else if eq .Values.loki.storage.type "filesystem" }}
filesystem:
